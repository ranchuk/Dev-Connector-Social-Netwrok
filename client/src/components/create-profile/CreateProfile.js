            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                ...
                <TextFieldGroup
                  ...
                  info="Could be your own website or one  a company one"
                />
                <TextFieldGroup
                  ...
                  info="City or city & state suggested (eeg. Boston, MA)"
                />
                <TextFieldGroup
                  placeholder="Skills"
                  name="skills"
                ...
                <TextFieldGroup
                  ...
                  name="guthubusername"
                  value={this.state.guthubusername}
                  onChange={this.onChange}
                  error={errors.guthubusername}
